...
class stats:
    def __init__(self):
        ...
        self.IVAN_DRAGO=Personagem("IVAN DRAGO", 3000, 1, 40, 0, (self.ataque_perto, self.tiro))
        ...
        self.STALIN_=Personagem("STALIN", 2000, 0.8, 35, 150, (self.ataque_invocar, magia()))
        self.GORBACHOV_=Personagem("GORBACHOV", 3500, 0.2, 40, 0, (self.ataque_perto, magia()))
        self.IVAN_DRAGO_=Personagem("IVAN DRAGO", 3000, 1, 40, 0, (self.ataque_perto, self.tiro))
        self.RASPUTIN_=Personagem("RASPUTIN", 1500, 1, 2, 190, (cura(), magia()))
        self.RAMBO_=Personagem("RAMBO", 3000, 1.2, 40, 0,(self.ataque_perto, self.tiro))
        self.MUHAMMAD_ALI_=Personagem("MUHAMMAD ALI", 1800, 3, 50, 0,(self.ataque_perto, dash()))
        self.JESSE_JAMES_=Personagem("JESSE JAMES", 2800, 1.2, 50, 120,  (self.ataque_perto, self.tiro))
        self.JOHN_F_KENNEDY_=Personagem("JOHN F KENNEDY", 1000, .8, 50, 30, (self.ataque_invocar, magia()))
