...
class Historia:
    def __init__(self, tela):
        ...
        font_subtitulo = pg.font.SysFont(None, Constantes.Fonte_HISTORIA)
        self.titulo = font_subtitulo.render(
            f'Apos os eventos da tenebrosa guerra fria 1', True, Constantes.COR_TITULO)
        self.subtitulo = font_subtitulo.render(
            f'o verão derreteu os planos de conquista mundial de URSS e USA', True, Constantes.COR_TITULO)
        self.subtitulo2 = font_subtitulo.render(
            f'Porém após a segunda era glacial, a tecnologia', True, Constantes.COR_TITULO)
        self.subtitulo3 = font_subtitulo.render(
            f'misteriosamente voltou a decada de 60 e a guerra esta de volta', True, Constantes.COR_TITULO)
        self.subtitulo4 = font_subtitulo.render(
            f'Assim como a URSS', True, Constantes.COR_TITULO)
        self.subtitulo5 = font_subtitulo.render(
            f'(Soyoz Nyerooshimiy Ryespooblik svobodnikh)', True, Constantes.COR_TITULO)
        self.subtitulo6 = font_subtitulo.render(
            f'Os agentes precisam recuperar o santo Graal ', True, Constantes.COR_TITULO)
        self.subtitulo7 = font_subtitulo.render(
            f'Com ele, poderão finalmente ressucitar...', True, Constantes.COR_TITULO)
        self.subtitulo8= font_titulo.render(
            f'Napoleão, a cartada final', True, Constantes.COR_TITULO)
    ...
    def desenha(self):
        ...
        py = (0.2 * Constantes.ALTURA_TELA // 2)
